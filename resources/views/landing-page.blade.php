            ...
            <header class="with-background">
                <div class="top-nav container">
                    <div class="top-nav-left">
                        <div class="logo">{{setting('site.title')}}</div>
                ...
                <div class="hero container">
                    ...
                    <div class="hero-copy">
                        ...
                        <div class="hero-buttons">
                            <a href="{{route('login')}}" class="button button-white">Login</a>
                            
                        </div>
                    </div> <!-- end hero-copy -->

                    <div class="hero-image">
                        <img src="http://www.natureessence.in/images/grocery.png" alt="hero image">
                    </div> <!-- end hero-image -->
                </div> <!-- end hero -->
                @else
                <div class="hero container">
